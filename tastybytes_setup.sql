...
CREATE TABLE frostbyte_tasty_bytes.analytics.shift_sales CLONE frostbyte_tasty_bytes_dev.harmonized.shift_sales;
...
ALTER TABLE FROSTBYTE_TASTY_BYTES.ANALYTICS.SHIFT_SALES SET CHANGE_TRACKING = TRUE;
